...
def match_planar_3D(lattice_size,stabilizer_type,anyon_positions,time_space_weights,boundary_weight = 1.11 ,print_graph=False):
    ...
    ## PART 2: Generate list of boundary nodes linked to each 
