...
## 14/03/14: Update, Change this to a new graph making strategy in line with that of SCB. Construct two copies of the graph and then link the copies
## to correspond to boundary matching. 
...
'''
    for t in range(total_time):
        ...
        all_boundary_nodes2+=[boundary_nodes_positions_t]
...
#        tt2 = time.time()
        ...
        # fully connect boundary nodes within layer AND TO LAYER BELOW with  weight 0
